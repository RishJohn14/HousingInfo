...
function GetInsightsPage() {
    ...
    //function that gets the most and least affordable neighbourhoods from backend and update state
    ...
    //function that gets the housing statistics for each type of house
